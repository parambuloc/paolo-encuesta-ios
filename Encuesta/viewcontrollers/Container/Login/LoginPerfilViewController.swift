//
//  LoginPerfilViewController.swift
//  Encuesta
//
...
class LoginPerfilViewController: PerfilViewController {
    ...
    @IBAction func login(_ sender: UIButton) {
        if txtUser.text?.trim() != nil {
            if txtContraseña.text?.trim() != nil {
